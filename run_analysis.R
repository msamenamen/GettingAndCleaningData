run_analysis <- function() {
	...
	ytestActivity <- read.table("./test/y_test.txt", sep = "", header = FALSE)
    ytrainActivity <- read.table("./train/y_train.txt", sep = "", header = FALSE)
	...
	XtestFeatures <- read.table("./test/X_test.txt", sep = "", header = FALSE)
    XtrainFeatures <- read.table("./train/X_train.txt", sep = "", header = FALSE)
	...
	dataFeatures <- rbind(XtestFeatures, XtrainFeatures)
		...
		dataFeaturesNames <- read.table("features.txt", sep = "", header = FALSE)
